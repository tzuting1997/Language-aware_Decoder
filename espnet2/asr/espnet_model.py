...
class ESPnetASRModel(AbsESPnetModel):
    ...
    def __init__(
        ...
        self.chn_start = chn_start
        self.chn_end = chn_end
        ...
        if self.use_transducer_decoder:
            ...
            if self.ctc_weight != 1.0:
                loss_att, acc_att, cer_att, wer_att = self._calc_att_loss(
                    encoder_out, encoder_out_lens, text, text_lengths, self.chn_start, self.chn_end, self.eng_start ,self.eng_end, self.sym_low, self.sym_up
                )
    ...
    def _calc_att_loss(
        ...
        # 1. Forward decoder
        decoder_out, _ = self.decoder(
            encoder_out, encoder_out_lens, ys_in_pad, ys_in_lens, chn_start, chn_end, eng_start ,eng_end, sym_low, sym_up
        )
