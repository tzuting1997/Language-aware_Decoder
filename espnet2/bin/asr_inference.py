...
class Speech2Text:
    ...
    def __init__(
        ...
        self.chn_start = asr_train_args.model_conf['chn_start']
        self.chn_end = asr_train_args.model_conf['chn_end']
        self.eng_start = asr_train_args.model_conf['eng_start']
        self.eng_end = asr_train_args.model_conf['eng_end']
        self.sym_low = asr_train_args.model_conf['sym_low']
        self.sym_up = asr_train_args.model_conf['sym_up']
        if enh_s2t_task:
        ...
        if asr_model.use_transducer_decoder:
            ...
            if time_sync:
                ...
                beam_search = BeamSearch(
                    ...
                    sos=asr_model.sos,
                    eos=asr_model.eos,
                    chn_start=self.chn_start,
                    chn_end=self.chn_end,
                    eng_start=self.eng_start,
                    eng_end=self.eng_end,
    ...
    def _decode_single_sample(self, enc: torch.Tensor):
        if self.beam_search_transducer:
            ...
            nbest_hyps = self.beam_search(
                x=enc, chn_start=self.chn_start, chn_end=self.chn_end, eng_start=self.eng_start, eng_end=self.eng_end, sym_low=self.sym_low, sym_up=self.sym_up, maxlenratio=self.maxlenratio, minlenratio=self.minlenratio
            )
