...
class BeamSearch(torch.nn.Module):
    ...
    def forward(
        self, x: torch.Tensor, chn_start, chn_end, eng_start, eng_end, sym_low, sym_up, maxlenratio: float = 0.0, minlenratio: float = 0.0
    ) -> List[Hypothesis]:
        """Perform beam search.
        ...
        for i in range(maxlen):
            ...
            best = self.search(running_hyps, x, chn_start, chn_end, eng_start, eng_end, sym_low, sym_up)
