...
class BatchBeamSearch(BeamSearch):
    ...
    def score_full(
        self, hyp: BatchHypothesis, x: torch.Tensor, chn_start, chn_end, eng_start, eng_end, sym_low, sym_up
        ...
        for k, d in self.full_scorers.items():
            scores[k], states[k] = d.batch_score(hyp.yseq, hyp.states[k], x, chn_start, chn_end, eng_start, eng_end, sym_low, sym_up)
    ...
    def search(self, running_hyps: BatchHypothesis, x: torch.Tensor, chn_start, chn_end, eng_start, eng_end, sym_low, sym_up) -> BatchHypothesis:
        ...
        scores, states = self.score_full(running_hyps, x.expand(n_batch, *x.shape), chn_start, chn_end, eng_start, eng_end, sym_low, sym_up)
